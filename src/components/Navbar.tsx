...
export function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-1 h-36 py-16 left-0 right-0 z-50 transition-all duration-500 border-b border-transparent ${
        isScrolled || !isHome
          ? "bg-background/95 backdrop-blur-md border-border py-6 shadow-sm"
          : "bg-transparent py-6"
      }`}
    >
